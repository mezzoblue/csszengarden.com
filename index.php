...
<div class="page-wrapper">
	...
	<section class="intro" id="zen-intro">
		...
		<div class="summary" id="zen-summary">
			...
			<p>Download the sample <a href="/zengarden-sample.html" title="This page's source HTML code, not to be modified.">html file</a> and <a href="/zengarden-sample.css" title="This page's sample CSS, the file you may modify.">css file</a></p>
		</div>
	...
	<div class="main supporting" id="zen-supporting" role="main">
		...
		<div class="participation" id="zen-participation">
			...
			<? /*<p class="p4">update: I&#8217;m looking for translators. If you are fluent in English and another language, this is another way to get involved with the project. Please <a href="http://www.mezzoblue.com/contact/" title="Send me an e-mail mentioning which languages you are fluent in.">contact me</a> for details. Existing translations are <a href="http://www.mezzoblue.com/zengarden/translations/">available</a>.</p>*/ ?>
		</div>
		...
		<div class="requirements" id="zen-requirements">
			...
			<p>Bandwidth graciously donated by <a href="http://www.mediatemple.net/">mediatemple</a>. Now available: <a href="http://www.amazon.com/exec/obidos/ASIN/0321303474/mezzoblue-20/">Zen Garden, the book</a>.</p>
		</div>
...
?>
					<li class="next">
						<a href="?cssfile=<?php echo $currentDesign ?>&amp;page=<?php echo $thisPage + 1 ?>">
							Next Designs <span class="indicator">&raquo;
						</a>
					</li>
<?php
	}
...
?>
					<li class="previous">
						<a href="?cssfile=<?php echo $currentDesign ?>&amp;page=<?php echo $thisPage - 1 ?>">
							<span class="indicator">&laquo; Previous Designs
						</a>
					</li>
<?php
	}
