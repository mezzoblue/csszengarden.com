...
<div id="container">
	<div id="intro">
		...
		<div id="quickSummary">
			<p class="p1"><span>Une demonstration de ce qu'on peut accomplir lorsqu'on utilise les <acronym title="Cascading Style Sheets">CSS</acronym> pour la conception web.  S&eacute;lectionez n'importe quelle feuille de style list&eacute;e pour charger le r&eacute;sultat sur cette page.</span></p>
	...
	<div id="supportingText">
		...
		<div id="footer">
			...
			<a href="http://creativecommons.org/licenses/by-nc-sa/1.0/" title="Voir les details de la license de ce site, courteoisie de Creative Commons.">cc</a> &nbsp;
			<a href="http://www.mezzoblue.com/zengarden/faq/#s508" title="V&eacute;rifiez l'accessibilit&eacute; de ce site d'apr&egrave;s le U.S. Section 508">508</a> &nbsp;
			<a href="http://www.mezzoblue.com/zengarden/faq/#aaa" title="V&eacute;rifiez l'accessibilit&eacute; de ce site d'apr&egrave;s le Guide d'Accessibility de WAI, version 1">aaa</a>
		</div>
...
<?php
					...
					for ($a = ($listStart + 1); $a <= $listEnd; $a++) {
						...
						echo "\t\t\t\t\t";
						echo "<li><a href=\"?cssfile=/${tempLink}/${tempLink}.css&amp;page=${thisPage}\" title=\"AccessKey: ${d}\" accesskey=\"${d}\">${styleName[$b]}</a> par <a href=\"${styleURL[$b]}\" class=\"c\">${styleCreator[$b]}</a></li>";
						echo "\n";
						$c = $c + 1;
					}
?>
