...
<body onload="window.defaultStatus='css Zen Garden: Die Sch&ouml;nheit der CSS-Gestaltung';" id="css-zen-garden">
...
<div id="container">
	...
	<div id="supportingText">
		...
		<div id="requirements">
			...
			<p class="p5"><span>Bandbreite frendicherweise gespendet von <a href="http://www.dreamfirestudios.com/">DreamFire Studios</a></span></p>
		</div>
		...
		<div id="footer">
			...
			<a href="http://creativecommons.org/licenses/sa/1.0/" title="Sehen sie Details zur Lizenz dieser Seite, mit freundlicher Genehmigung von Creative Commons.">cc</a> &nbsp;
			<a href="http://bobby.watchfire.com/bobby/bobbyServlet?URL=http%3A%2F%2Fwww.mezzoblue.com%2Fzengarden%2F&amp;output=Submit&amp;gl=sec508&amp;test=" title="Pr&uuml;fen Sie die Zug&auml;nglichkeit dieser Seite gem&auml;&szlig; der U.S. Section 508">508</a> &nbsp;
			<a href="http://bobby.watchfire.com/bobby/bobbyServlet?URL=http%3A%2F%2Fwww.mezzoblue.com%2Fzengarden%2F&amp;output=Submit&amp;gl=wcag1-aaa&amp;test=" title="Pr&uuml;fen Sie die Zug&auml;nglichkeit dieser Seite gem&auml;&szlig; der WAI Content Accessibility Guidelines 1">aaa</a>
		</div>
...
<?php
					...
					for ($a = ($listStart + 1); $a <= $listEnd; $a++) {
						...
						echo "\t\t\t\t\t";
						echo "<li><a href=\"${tempLink}&amp;page=${thisPage}\" title=\"AccessKey: ${d}\" accesskey=\"${d}\">${styleName[$b]}</a> von <a href=\"${styleURL[$b]}\" class=\"c\">${styleCreator[$b]}</a></li>";
						echo "\n";
						$c = $c + 1;
					}
?>
...
<?php
					echo "\t\t\t\t\t";
					echo "<li><a href=\"${currentDesign}\" title=\"View the source CSS file for the currently-viewed design, AccessKey: v\" accesskey=\"v\"><span class=\"accesskey\"><acronym title=\"Cascading Style Sheets\">CSS</acronym> von dieser Seite</a></li>";
?>
...
<!-- Sorry wegen dem hier. ich haben keine Serverstatistiken, es ist also ein Zugeständnis and die Eitelkeit -->
