<?php
	...
	$intro = array(
		...
		"summary-p1" => 'Une demonstration de ce qu\'on peut accomplir lorsqu\'on utilise les <acronym title="Cascading Style Sheets">CSS</acronym> pour la conception web.  S&eacute;lectionez n\'importe quelle feuille de style list&eacute;e pour charger le r&eacute;sultat sur cette page.',
		...
		"preamble-p1" => 'Les reliques pass&eacute;es des s&eacute;lecteurs sp&eacute;cifique aux navigateurs, des <acronym title="Document Object Model">DOM</acronym>s incompatibles, et du manque de support des <acronym title="Cascading Style Sheets">CSS</acronym> encombrent un long chemin sombre et morne.',
		"preamble-p2" => 'Aujourd\'hui, nous devons nous clarifier l\'esprit et nous d&eacute;barassez des pratiques pass&eacute;es.  La r&eacute;v&eacute;lation de la v&eacute;ritable nature du Web est maintenant possible, gr&acirc;ce aux efforts infatigables des gens du <acronym title="World Wide Web Consortium">W3C</acronym>, du <acronym title="Web Standards Project">WaSP</acronym> et des cr&eacute;ateurs des principaux navigateurs.',
	...
	$sidebar = array(
		...
		"view-css-text" => 'Voir le <acronym title=\"Cascading Style Sheets\">CSS</acronym> pour cette conception',
		"css-resources-title" => 'Links to great sites with information on using CSS.',
		"css-resources-text" => 'Ressources <acronym title="Cascading Style Sheets">CSS</acronym>',
		"zen-faq-title" => 'Une liste de Questions Souvent Demand&eacute;es au sujet du Jardin Zen css',
		"zen-faq-text" => '<acronym title="Questions Souvent Demand&eacute;es, ou Frequently Asked Questions en Anglais">FAQ</acronym></a>',
